...
tfLayoutMagicCell {
  device {
    ...
    ruleDef {
      ...
      { minChannelWidth 0.25 }
      { minGateSpace 0.3 }
      { minOd2GateExtension 0.45 }
      { minPoly2GateExtension 0.2 }
      { minCo2OdEnclosure 0.12 }
      { minCoSpace 0.25 }
      { minCo2GateSpace 0.15 }
      { minCoWidth 0.23 }
      { minCo2MetEnclosure { 0.12 0.12 } }
    ...
    stackVia {
      { minViaWidth 0.5 }
      { minVia2MetEnclosure 0.2 }
      { minViaSpace 0.45 }
      { minVia2Met2Enclosure 0.15 }
    }
  }
  device {
    deviceName { NMOS_0d18V }
    layerDef {
      { Co CONT }
      { Met ME1 }
      { Poly PO1 }
...
size { { Res by 1.8 } HRP}
  ...
  capacitor {
    ...
    ruleDef {
      ...
      { minCoSpace 0.27 }
      { minCo2Cap1Space 1.5 }
      { minCo2Cap1Enclosure 0.8 }
      { minCo2Cap2Enclosure 0.8 }
      { minCap1Width 1 }
      { minCap2Width 1 }
  ...
  contactDevice {
    ...
    ruleDef {
      ...
      { defCoSpaceY 0.27 }
      { minCoSpace 0.27 }
      { minCo2Lay1RangeEnclosure { 0.2 0.2 } }
      { minCo2Lay2RangeEnclosure { 0.15 0.15 } }
    }
  }
  contactDevice {
  ...
  contactDevice {
    ...
    ruleDef {
      ...
      { defCoSpaceY 0.27 }
      { minCoSpace 0.27 }
      { minCo2Lay1RangeEnclosure { 0.4 0.4 } }
      { minCo2Lay2RangeEnclosure { 0.15 0.15 } }
    }
  }
  guardRing {
    guardRingName { P_Guard_Ring }
    layerDef {
      { Body DIFF }
      { Co CONT }
      { Met ME1 }
    ...
    ruleDef {
      ...
      { minCoSpace 0.25 }
      { minCo2MetEnclosure 0.15 }
      { minCo2BodyEnclosure 0.15 }
      { minBodyWidth 0.3 }
      { minBodyNotch 0.6 }
      { minMetWidth 0.5 }
      { minMetNotch 0.45 }
      { minBodySpace 0.6 }
      { minBody2PolySpace 0.2 }
      { minBody2ImpEnclosure 0.2 }
      { minImpNotch 0.6 }
    }
  }
  guardRing {
    guardRingName { N_Guard_Ring }
    layerDef {
      { Body DIFF }
      { Co CONT }
      { Met ME1 }
